export async function onRequestPost(context) {
  try {
    ...
    if (!apiKey) {
      return new Response(
        JSON.stringify({ success: false, error: 'RESEND_API_KEY environment variable is not set in Cloudflare.' }),
    ...
    // Note: Resend requires a domain or onboarding email domain.
    // Default testing sender: "onboarding@resend.dev"
